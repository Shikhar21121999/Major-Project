        ...
        "
                >
                    <div>
                        <Link to="/" style={{ textDecoration: 'none' }}>
                            ...
                            <h1 className="text-4xl">Voice Translator</h1>
                        </Link>
                    </div>
              ...
              md:pt-0"
                        >
                            ...
                            <li>
                                <Link to="/translate" style={{ textDecoration: 'none' }} class="md:p-4 py-2 block text-2xl text-purple-900 hover:text-gray-900">Translate
                                </Link>
                            </li>
                            <li>
